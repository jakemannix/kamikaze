...
public class NamedDisjunctionSumScorer extends Scorer {
...
//
//  protected String[] subScorerNames;
//
...
//   */
//  public NamedDisjunctionSumScorer( List subScorers, int minimumNrMatchers) {
//    super(null);
//
//    nrScorers = subScorers.size();
//
//    currentScores = new float[nrScorers];
//    subScorerNames = new String[nrScorers];
//
//    for(int i=0; i<nrScorers; i++)
//    {
//      NamedScorer scorer = (NamedScorer)subScorers.get(i);
//      subScorerNames[i] = scorer.getName();
//      scorer.setId(i);
//    }
//
...
//   */
//  public NamedDisjunctionSumScorer(List subScorers) {
//    this(subScorers, 1);
//  }
//
...
//      Arrays.fill(currentScores, 0f);
//      currentDoc = scorerDocQueue.topDoc();
//      NamedScorer topScorer = (NamedScorer) scorerDocQueue.top();
//      currentScores[topScorer.getId()] = topScorer.score();
...
//        }
//
//        NamedScorer namedScorer = (NamedScorer)scorerDocQueue.top();
//
//        currentScores[namedScorer.getId()] = namedScorer.score();
//
//        //currentScore += scorerDocQueue.topScore();
//        nrMatchers++;
//      } while (true);
...
//  {
//    float score = 0;
//    for(float subScore : currentScores) score += subScore;
//    return score;
//  }
//
...
//  }
  ...
  protected NamedOrDocIdSetIterator iter;

  public NamedDisjunctionSumScorer(NamedOrDocIdSetIterator iter, Similarity similarity) {
    super(similarity);
    this.iter = iter;
  }
